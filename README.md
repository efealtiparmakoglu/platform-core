...
![Build](https://github.com/efealtiparmakoglu/platform-core/workflows/CI%20Pipeline/badge.svg)
...
```bash
# Clone
git clone https://github.com/efealtiparmakoglu/platform-core.git
cd platform-core
